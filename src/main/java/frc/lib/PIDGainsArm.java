...
public class PIDGainsArm {
  public final double p;
  public final double i;
  public final double d;

  public PIDGainsArm(double _p, double _i, double _d) {
    p = _p;
    i = _i;
    d = _d;
  }
  ...
  // }
    ...
    public static void setSparkMaxGains(SparkClosedLoopController _controller, PIDGainsArm _gains) {
